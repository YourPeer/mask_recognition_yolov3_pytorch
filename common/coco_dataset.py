...
class COCODataset(Dataset):
    def __init__(self, path_list, img_size, is_training, is_debug=False):
        self.img_files = []
        self.label_files = []
        for path in open(path_list, 'r'):
            img_path="../data/JPEGImages/"+path.replace("txt",'jpg').strip("\n")
            label_path = "../data/Annotation/"+path.strip("\n")
...
if __name__ == "__main__":
    dataloader = torch.utils.data.DataLoader(COCODataset("../data/path_list.txt",
